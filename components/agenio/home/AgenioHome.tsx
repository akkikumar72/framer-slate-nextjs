  ...
  return (
    <main>
      ...
      <section className={styles.hero} id="hero">
        ...
        <div className={styles.heroCopy}>
          ...
          <div>
            ...
            <DarkButton href="/agenio/services">Explore Services</DarkButton>
          </div>
        </div>
      </section>
      ...
      <section aria-roledescription="carousel" className={styles.projectShowcase}>
        ...
        />
        <PixelSteps dark />
        <Link className={styles.projectOverlay} href={`/agenio/projects/${project.slug}`}>
          <h3>{project.title}</h3>
          <p>{project.copy}</p>
      ...
      <section className={styles.team}>
        ...
        <div className={styles.teamGrid}>
          ...
          <article className={styles.joinCard}>
            ...
            <LightButton href="/agenio/contact">Apply to Join Us</LightButton>
          </article>
        </div>
      </section>
