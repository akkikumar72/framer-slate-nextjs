...
import { AgenioContactPage } from "@/components/agenio/static/AgenioStaticPages";
...
export default function AgenioContactRoute() {
  return <AgenioContactPage />;
}
