    ...
    <main className={styles.homeMain}>
      <section className={styles.hero}>
        ...
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroActions}><RiveroButton href="/contact-us" light>Get Started for Free</RiveroButton><RiveroButton href="/appointment">Book A Demo</RiveroButton></div>
        </div>
      ...
      <section className={styles.powerful}>
        ...
        <div className={styles.hrCardStack}>{hrCards.map((card, index) => <article className={index % 2 ? styles.hrCardReverse : ""} data-rivero-reveal="card" key={card.title}>
          ...
          <div className={styles.hrCopy}><i>{card.icon}</i><h3>{card.title}</h3><p>{card.copy}</p><Link href="/feature">Learn More <span>↗</span></Link></div>
        </article>)}</div>
      </section>
