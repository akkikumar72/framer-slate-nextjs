...
const navItems = [
  { href: "/saazai/features", label: "Features" },
  { href: "/saazai/pricing", label: "Pricing" },
  { href: "/saazai/contact", label: "Contact" },
];
...
function SaazaiHeader() {
  ...
  return (
    <header className={styles.header}>
      <Link aria-label="Saazai home" className={styles.brand} href="/saazai">
        <LogoMark />
        <span>Saazai</span>
      </Link>
      ...
      <Link className={styles.headerCta} href="/saazai/contact">
      ...
      >
        <Link href="/saazai">Home</Link>
        {navItems.map((item) => (
          <Link href={item.href} key={item.href}>
            {item.label}
          </Link>
        ))}
        <Link href="/saazai/about">About us</Link>
        <Link href="/saazai/blog">Blog</Link>
        <Link href="/saazai/career">Careers</Link>
      </nav>
    </header>
  );
}
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.footerGrid}>
        <FooterColumn
          links={[
            ["/saazai", "Home"],
            ["/saazai/about", "About us"],
            ["/saazai/pricing", "Pricing"],
          ]}
          title="Main Pages"
        />
        <FooterColumn
          links={[
            ["/saazai/blog", "Blog"],
            ["/saazai/career", "Careers"],
            ["/saazai/integration", "Integrations"],
          ]}
          title="Inner pages"
        />
        <FooterColumn
          links={[
            ["/saazai/changelog", "Changelog"],
            ["/saazai/contact", "Contact"],
            ["/saazai/privacy", "Privacy"],
          ]}
          title="Utility pages"
        />
      ...
      <div className={styles.copyright}>
        ...
        <Link href="/saazai/privacy">Privacy policy</Link>
      </div>
    </footer>
  );
}
