  ...
  return (
    <article className={styles.planCard} data-rivero-reveal="card" style={{ "--rivero-delay": `${index * 100}ms` } as CSSProperties}>
      <div className={styles.planTop}>
        ...
        <p>{plan.copy}</p>
        <RiveroButton href="/rivero/contact-us">Get Started</RiveroButton>
      </div>
...
export function FeaturePage() {
  return <RiveroPageFrame><main className={styles.gradientPage}>
    <section className={styles.featureHero}><div aria-hidden="true" className={styles.heroPixels}/><div className={styles.featureHeroCopy}><span>Join +1000 scaling business</span><h1>Powerful Features for Modern HR Teams Everywhere</h1><p>Simplify your HR operations with intelligent automation and powerful tools designed to manage people payroll.</p><RiveroButton href="/rivero/contact-us" light>Get started for free</RiveroButton></div><img alt="Rivero analytics dashboard" src="/rivero/assets/914b72c5ab5a9a1c.png"/></section>
    <TrustedStrip />
...
export function RiveroNotFoundPage() {
  return <RiveroPageFrame><main className={styles.lightPage}><section className={styles.notFound}><img alt="404 Image" src="/rivero/assets/f5b98463cf9909a4.png"/><p>Page you’er Looking For Is Not Found!</p><RiveroButton href="/rivero">Return to The Website</RiveroButton></section></main></RiveroPageFrame>;
}
