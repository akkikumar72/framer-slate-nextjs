...
const navItems = [
  { href: "/jayden#home", label: "Home", icon: "home", section: "home" },
  { href: "/jayden/work", label: "Works", icon: "work" },
  { href: "/jayden/service", label: "Services", icon: "service" },
  { href: "/jayden/about", label: "About", icon: "about" },
  {
    href: "/jayden#testimonial",
    label: "Testimonial",
    icon: "testimonial",
    section: "testimonial",
  },
  { href: "/jayden#pricing", label: "Pricing", icon: "pricing", section: "pricing" },
  { href: "/jayden#faq", label: "FAQ", icon: "faq", section: "faq" },
  { href: "/jayden/contact", label: "Contact", icon: "contact" },
] as const;
...
function isActive(
  ...
  if ("section" in item) {
    return pathname === "/jayden" && activeSection === item.section;
  }
...
export function JaydenShell({ children }: { children: ReactNode }) {
  ...
  const handleRailClick = (
    ...
    if ("section" in item && pathname === "/jayden") {
    ...
    <div className={styles.site}>
      ...
      <header className={styles.header}>
        <div className={styles.headerGrid}>
          <Link className={styles.brand} href="/jayden" aria-label="Jayden home">
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerInner}>
        ...
        <Link className={styles.bookCall} href="/jayden#contact">
