...
const navItems = [
  { href: "/agenio", label: "Home" },
  { href: "/agenio/about-us", label: "About us" },
  { href: "/agenio/services", label: "Services" },
  { href: "/agenio/projects", label: "Projects" },
  { href: "/agenio#pricing-plan", label: "Pricing" },
  { href: "/agenio/contact", label: "Contact" },
];
  ...
  return (
    <>
      ...
      <header className={styles.header}>
        <Link aria-label="Agenio home" className={styles.headerLogo} href="/agenio">
          <Wordmark />
        </Link>
        ...
        <Link className={`${styles.shadowButton} ${styles.headerRequest}`} href="/agenio#contact">
          Request
        </Link>
        <button
          aria-expanded={open}
    ...
    <>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerMeta}>
          ...
          <Link href="/agenio#hero">Back to Home ↑</Link>
        </div>
      </footer>
      <a
