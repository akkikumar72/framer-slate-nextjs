    ...
    <>
      ...
      <section className={styles.intro}>
        ...
        <div className={styles.introBody}>
          ...
          <div className={styles.introStatement}>
            ...
            <ArrowLink href="/palmer/contact">Contact</ArrowLink>
          </div>
        </div>
      ...
      <section className={styles.work}>
        ...
        <div className={styles.workIntro}>
          ...
          <ArrowLink href="/palmer/work">See works</ArrowLink>
        </div>
      ...
      <section className={styles.testimonials}>
        ...
        <div className={styles.testimonialAction}>
          <ArrowLink href="/palmer/contact">Get in touch</ArrowLink>
        </div>
        ...
        <div className={styles.planGrid}>
          {plans.map((plan, index) => (
            <article key={plan.name}>
              ...
              <ArrowLink href="/palmer/contact" light>
                Start a project
              </ArrowLink>
            </article>
          ))}
          ...
          {articles.map((article, index) => (
            <article className={styles.articleCard} key={article.slug}>
              <Link
                ...
                href={`/palmer/article/${article.slug}`}
              >
                <img
              ...
              <div className={styles.articleContent}>
                ...
                <ArrowLink href={`/palmer/article/${article.slug}`}>
                  View
                </ArrowLink>
              </div>
            </article>
