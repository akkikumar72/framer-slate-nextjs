  ...
  return (
    <>
      <section className={styles.aboutHero}>
        ...
        <PrimaryButton href="/contact">Try Free for 14 Days</PrimaryButton>
      ...
      <StandardSection>
        <div className={styles.foundationIntro}>
          <div>
            ...
            <Link className={styles.foundationLink} href="/features">
      ...
      <section className={styles.hiring}>
        ...
        <PrimaryButton href="/career">Explore jobs</PrimaryButton>
      </section>
