...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/saazai/blog/${post.slug}`,
    },
    openGraph: {
      title: post.title,
      description: post.excerpt,
    ...
    <div className={styles.page}>
      ...
      <article className={styles.article}>
        <div className={styles.articleBody}>
          ...
          <Link className={styles.backLink} href="/saazai/blog">
            Back To Blog
          </Link>
        </div>
        ...
        <aside className={styles.articleAside}>
          ...
          <Link className={styles.asideButton} href="/saazai/contact">
