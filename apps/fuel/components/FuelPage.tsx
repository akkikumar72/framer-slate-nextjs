...
const portfolioItems = [
  {
    ...
    href: "/work/portfolio/vellfire-calibration",
  },
  {
    number: "02",
    ...
    href: "/work/portfolio/dunwill-lanson",
  },
  {
    number: "03",
    title: "Noara Willis",
    ...
    href: "/work/portfolio/noara-willis",
  },
  {
    number: "04",
    title: "Nike Studios",
    ...
    href: "/work/portfolio/nike-studios",
  },
];
    ...
    <main className={styles.page} id="top" ref={rootRef}>
      ...
      <section className={styles.about} id="about">
        ...
        <div className={styles.aboutGrid} data-fuel-reveal>
          ...
          <div className={styles.resultColumn}>
            ...
            <FuelArrowLink href="/work/portfolio">
              Explore Now
            </FuelArrowLink>
          </div>
        </div>
      ...
      <section className={styles.portfolio} id="portfolio">
        ...
        <div className={styles.portfolioIntro}>
          ...
          <a className={styles.seeAll} href="/work/portfolio">
      ...
      <section className={styles.cinematicCta}>
        ...
        <div className={styles.cinematicCenter} data-fuel-reveal>
          ...
          <FuelArrowLink dark href="/contact">
            Contact Now
          </FuelArrowLink>
        </div>
      </section>
