  ...
  return (
    <header className={`${styles.header} ${solid ? styles.headerSolid : ""} ${light ? styles.headerLight : ""}`}>
      <nav aria-label="Rivero main navigation" className={styles.headerInner}>
        <Link aria-label="Rivero home" className={styles.logo} href="/">
        ...
        <Link className={styles.headerCta} href="/contact-us">
        ...
        <div className={`${styles.mobileMenu} ${mobileOpen ? styles.mobileMenuOpen : ""}`}>
          ...
          <Link className={styles.mobileCta} href="/contact-us">Get started for free</Link>
        </div>
      </nav>
    </header>
  );
  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        ...
        ["Contact", "/contact-us"], ["Integrations", "/integrations"],
      ],
    },
  ];
  ...
  return (
    <footer className={styles.footer}>
      <section className={styles.footerCta}>
        ...
        <div className={styles.footerCtaCopy}>
          ...
          <div className={styles.footerActions} data-rivero-reveal style={{ "--rivero-delay": "200ms" } as CSSProperties}>
            <RiveroButton href="/contact-us" light>Get Started for Free</RiveroButton>
            <Link className={styles.button} href="/appointment"><span>Book A Demo</span><i aria-hidden="true">→</i></Link>
          </div>
        </div>
      </section>
      ...
      <div className={styles.footerBody} data-rivero-reveal="card">
        <div className={styles.footerTop}>
          <div className={styles.footerBrand}>
            <Link href="/"><img alt="Rivero" src="/rivero/assets/eac89115f94d75a0.svg" /></Link>
        ...
        <div className={styles.footerCardBottom}>
          <RiveroButton href="/pricing-v1">Start Free Trial</RiveroButton>
      ...
      <div className={styles.footerBottom} data-rivero-reveal>
        ...
        <div><Link href="/legal/privacy-policy">Privacy Policy</Link><Link href="/legal/terms-conditions">Terms of Service</Link></div>
      </div>
    </footer>
  );
}
